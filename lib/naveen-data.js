...
export const NAVEEN = {
  ...
  heroBadges: [
    ...
    { t: "Design Systems", c: "from-rose-500 to-pink-600" },
  ...
  companies: [
    "EXL", "TELUS", "VVDN", "Barclays", "Samsung", "Amazon", "L&T", "Extreme Networks",
  ],
  skills: {
    Frontend: [
      "React.js (Hooks, Class)", "Next.js (SSR/CSR)", "TypeScript", "JavaScript (ES6+)",
      "Angular", "Vue.js", "Redux Toolkit", "Tailwind CSS", "HTML5 / CSS3",
      "Micro Frontend (MFE)", "Universal Design System", "Responsive Design",
    ],
    "Backend Exposure": [
      "Node.js", "Express.js", "REST API", "GraphQL",
      "Contentful (Headless CMS)", "API Auth & Error Handling",
    ],
    "Testing & Quality": [
      "Jest", "Mocha", "Jasmine", "React Testing Library",
      "Postman", "Swagger", "ESLint", "Prettier",
    ],
    "DevOps & Cloud": [
      "Git / GitHub / GitLab", "Docker", "Jenkins CI/CD",
      "GitHub Actions", "AWS", "Vercel", "Netlify",
    ],
    "Architecture & Agile": [
      "Micro Frontend Architecture", "Backend-for-Frontend (BFF)",
      "Domain-Driven Design", "Agile Scrum", "Jira / Confluence", "Sprint Planning",
    ],
  },
  experience: [
    {
      company: "EXL", role: "Senior Consultant 2", location: "Remote, Gurugram",
      type: "Service based MNC", duration: "Aug 2025 — Present",
      bullets: [
    ...
    {
      company: "TELUS", role: "Sr. Application Developer", location: "Remote, Noida",
      type: "Canada-based product organization", duration: "Feb 2024 — Jul 2025",
      bullets: [
    ...
    {
      company: "VVDN Technologies Pvt Ltd", role: "Sr. Web Developer", location: "Noida & Gurugram",
      type: "Service based MNC", duration: "Jun 2019 — Feb 2024",
      bullets: [
  ...
  projects: [
    { name: "Deployment Management & Service Monitoring Platform", client: "Barclays",
      duration: "Aug 2025 — Present", stack: ["React.js"], role: "Consultant II",
      summary: "Enterprise deployment management platform to orchestrate, track and monitor service deployments across environments with full visibility dashboards.",
      accent: "from-fuchsia-500 to-purple-600" },
    { name: "TELUS E-Commerce Platform", client: "TELUS",
      duration: "Feb 2024 — Jul 2025 (~18 mo)", stack: ["React.js", "Next.js", "Micro Frontend"],
      role: "Sr. Application Developer",
      summary: "Large-scale e-commerce platform for SIM card sales using Micro Frontend architecture. Built independently deployable MFEs and mentored 50+ engineers.",
      accent: "from-cyan-400 to-blue-600" },
    { name: "UI Component Library & Design System", client: "Extreme Networks",
      duration: "Jun 2023 — Jan 2024 (~7 mo)", stack: ["Angular"], role: "Sr. Frontend Developer",
      summary: "Reusable Angular component libraries and design system modules ensuring UI consistency across enterprise applications consumed by multiple product teams.",
      accent: "from-pink-500 to-rose-600" },
    { name: "Smart Building Management System", client: "Larsen & Toubro (L&T)",
      duration: "Apr 2022 — May 2023 (~14 mo)", stack: ["React.js", "IoT"], role: "Sr Frontend Developer (Solo)",
      summary: "Smart building automation platform for monitoring and controlling buildings through IoT devices with high-performance dashboards, charts and forms.",
      accent: "from-emerald-400 to-cyan-500" },
    { name: "Smart Water Bottle Platform", client: "Amazon",
      duration: "Oct 2021 — Mar 2022 (~6 mo)", stack: ["React.js", "Linux", "IoT"], role: "Frontend Developer",
      summary: "UI modules for an IoT-enabled smart water bottle displaying water level, temperature and TDS data via sensor integration on embedded displays.",
      accent: "from-amber-400 to-orange-600" },
    { name: "VVDN Video Collaboration Platform", client: "VVDN Technologies (Internal)",
      duration: "Mar 2021 — Sep 2021 (~7 mo)", stack: ["React.js"], role: "Senior Frontend Developer",
      summary: "Real-time collaboration features including screen sharing, screen recording, audio & video communication for an enterprise conferencing platform.",
      accent: "from-violet-500 to-indigo-600" },
    { name: "Samsung Employee Management System", client: "Samsung",
      duration: "Mar 2020 — Feb 2021 (~12 mo)", stack: ["Vue.js"], role: "Frontend Developer",
      summary: "Workforce administration platform with multiple business features delivered in close collaboration with cross-functional teams.",
      accent: "from-sky-400 to-blue-700" },
    { name: "Samsung Knox Security Platform", client: "Samsung",
      duration: "Jun 2019 — Feb 2020 (~9 mo)", stack: ["Vue.js"], role: "Junior Frontend Developer",
      summary: "Worked on Samsung Knox web applications — focused on bug fixing, debugging and enhancing security features for better stability.",
      accent: "from-teal-400 to-emerald-600" },
  ],
  services: [
    {
      icon: "Layers", title: "Frontend Architecture",
      desc: "Design scalable Micro Frontend & Module Federation systems with clean boundaries and shared design tokens.",
      points: ["MFE Strategy", "Module Federation", "BFF Pattern", "Design Systems"],
    },
    {
      icon: "Sparkles", title: "Premium UI Engineering",
    ...
    {
      icon: "Users", title: "Team Mentorship",
      desc: "Train, code-review, and uplift engineering teams. 50+ devs mentored and 20+ hiring interviews conducted.",
      points: ["Training", "Code Reviews", "Interviewing", "Agile Coaching"],
    },
    {
      icon: "Rocket", title: "DevOps & Delivery",
  ...
  testimonials: [
    {
      quote: "Naveen consistently delivered scalable Micro Frontend modules and made our React codebase a joy to work in. A natural mentor — the kind of engineer who lifts the whole team.",
      name: "Engineering Manager", role: "Product Org — TELUS (Canada)",
    },
    {
      quote: "He shipped 25+ UI features across enterprise clients and trained our interns from zero to productive. His code reviews are textbook material.",
      name: "Tech Lead", role: "VVDN Technologies",
    },
    {
      quote: "From Next.js SSR to Contentful integration, Naveen led with clarity. He's the rare frontend dev who thinks like an architect.",
      name: "Senior Architect", role: "E-Commerce Platform",
    },
  ],
  now: [
...
export function buildResumeContext() {
  ...
  const expText = n.experience
    .map((e) => `• ${e.role} at ${e.company} (${e.duration}) — ${e.location}. ${e.bullets.join(" ")}`)
    .join("\n");
  const projText = n.projects
    .map((p) => `• ${p.name} for ${p.client} (${p.duration}) — Stack: ${p.stack.join(", ")}. ${p.summary}`)
    .join("\n");
